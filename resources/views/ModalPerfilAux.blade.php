...
<!-- Modal -->
<div class="modal fade" id="ModalPerfilAux" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="ModalPerfilAux" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('Perfil.A')}}" method="POST" enctype="multipart/form-data" >
          @csrf
          @method('PUT')
